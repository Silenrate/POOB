...
public class Salon implements Serializable{
    ...
    private static transient bodyTicDao bodyDao;
	...
	public ArrayList<EnSalon> getElementos(){
		return elementos;
	}
    /**
    ...
    public Salon abrir(File file) throws bodyTICExcepcion{
    	return bodyDao.abra01(file);
    }
    public void guardarComo(File file) throws bodyTICExcepcion{
    	bodyDao.salve01(this,file);
    }
    public Salon importar(File file) throws bodyTICExcepcion{
    	return bodyDao.importe03(file);
    }
    public void exportarComo(File file) throws bodyTICExcepcion{
    	bodyDao.exporte03(this,file);
    }
}
