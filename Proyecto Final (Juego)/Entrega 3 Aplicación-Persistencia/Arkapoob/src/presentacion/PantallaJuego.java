...
public class PantallaJuego extends JFrame{
	...
	private JPanel gamebar,principalPanel;
	...
	private PantallaJuego(boolean isRandom,String color1,String color2) {
		setResizable(false);
		isGameOn = false;
		isSaved = false;
		isPaused = true;
	...
	public PantallaJuego(boolean isRandom,int jugadores,String color1,String color2){
		this(isRandom,color1,color2);
		this.jugadores = jugadores;
		prepareElementos();
		prepareAcciones();
	}
	public PantallaJuego(boolean isRandom,int jugadores,ArrayList<Jugador> players,String color1,String color2){
		this(isRandom,color1,color2);
		this.jugadores = jugadores;
	...
	private void prepareJuego(){
		juego = new Painter(this,random,jugadores);
		gamebar = new JPanel();
		new JLabel("        ");
		new JLabel("        ");
		new JLabel("        ");
	...
	private void prepareJuego(ArrayList<Jugador> players){
		...
		juego = new Painter(this,random,jugadores,nombres);
		gamebar = new JPanel();
		new JLabel("        ");
		new JLabel("        ");
		new JLabel("        ");
	...
	private void accionOpenFile(){
		...
		try{
			if (seleccion == JFileChooser.APPROVE_OPTION){
				juego.abrir(fileChooser.getSelectedFile());
				juego.accionJugar();
				accionPausa();
